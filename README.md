...
flowchart ini menyuruh user memilih role sebagai Administrator atau buyer untuk melakukan action sesuai dengan role nya. Administrator dapat melakukan action seperti menampilkan, menambah, mengupdate, dan menghapus part racing, sementara buyer dapat melakukan transaksi pembelian part racing atau melihat daftar part racing yang diperlihatkan oleh Administrator lewat monitor pas di toko dengan Jatim SpeedShop Application.
